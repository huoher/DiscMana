...
<pg:pager url="Singer.jsp" maxPageItems = "8" maxIndexPages="3" export="offset,currentPageNumber=pageNumber" isOffset="false"  index="half-full"  >
    <table class="table table-striped table-bordered table-hover  table-condensed">
        <tr bgcolor="#EFF3F7">
            <TD align="center">歌手名称</TD>
            <TD align="center">操作</TD>
        </tr>
        <c:if test="${!empty singers}">
            <c:forEach items="${singers}" var="singerLista">
                <pg:item>
                    <tr bgcolor="#EFF3F7">
                        <td align="center">${singerLista.name}</td>
                        <td><a href="/findDiscBySinger.action?singerid=${singerLista.id}">查看他（她）的专辑</a></td>
                    </tr>
                </pg:item>
            </c:forEach>
        </c:if>
