...
<%--<table>--%>
    ...
    <%--<c:forEach items="${ListCarts}" var="ListCart" >--%>
        <%--<tr>--%>
            ...
            <%--<td><c:out value="${ListCart.datetime}"></c:out></td>--%>
        <%--</tr>--%>
    <%--</c:forEach>--%>
<%--</table>--%>
...
<pg:pager url="listCarts.jsp" maxPageItems = "8" maxIndexPages="3" export="offset,currentPageNumber=pageNumber" isOffset="false"  index="half-full"  >
    <table class="table table-bordered">
        ...
        <c:if test="${!empty ListCarts}">
            <c:forEach items="${ListCarts}" var="discm">
                <pg:item>
                    <tr bgcolor="#EFF3F7">
                        ...
                        <td align="center">${discm.datetime}</td>
                    </tr>
                </pg:item>
            </c:forEach>
        </c:if>
